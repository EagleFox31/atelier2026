...
const TRIAL_PLAN = {
  ...
  description: 'Testez les outils Pro de gestion dans votre vrai atelier, sans carte bancaire. Les SMS opérateur restent désactivés pendant le pilote.',
  features: [
    'Outils Pro de gestion pendant 30 jours',
    '1 garage',
    'Utilisateurs illimités',
    'SMS opérateur non inclus',
